...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{route('payments.store')}}">
        @csrf
        @method("POST")
      ...
      <fieldset>
        ...
        <div class="form-group" data-sr="wait 0.3s, then enter bottom and hustle 100%">
            <label for="select" class="col-lg-2 control-label">أختر المطعم</label>
            <div class="col-lg-10">
              <select class="form-control" name="restaurant_id" >
                @foreach ($restaurants as $value)
                <option @if (old('restaurant_id')==$value->id)
                     @selected(true)
