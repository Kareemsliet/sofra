...
<div class="well bs-component" data-sr="wait 0s, then enter left and hustle 100%">
    ...
    <form class="form-horizontal" method="post" enctype="multipart/form-data" action="{{route('cities.update',$city->id)}}">
        @csrf
        @method("PUT")
      ...
      <fieldset>
        ...
        <div class="form-group" data-sr="wait 0.6s, then enter bottom and hustle 100%">
          ...
          <div class="col-lg-10 input-grup">
            ...
            <input type="text" name="name" value="{{$city->name}}" class="form-control text-right" placeholder="اسم المدينة">
            @error('name')
