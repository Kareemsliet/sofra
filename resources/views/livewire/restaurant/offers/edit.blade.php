                ...
                <form class="text-center" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="form-group choose-file">
                        <div class="photo">
                            ...
                            @else
                            <img src="{{asset('storage/restaurants/offers/')}}/{{$offer->image}}" alt="">
                            @endif
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="from">
                                    ...
                                    <input name="from"  wire:model.live='from' placeholder="من" type="text" id="from">
                                    @error('from')
                                    <span class="help-block text-right text-danger">{{$message}}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="to">
                                    <i class="fas fa-calendar-alt secondary-color"></i>
                                    <input name="to" wire:model.live='to' placeholder="الى"type="text" id="to">
                                    @error('to')
                                    <span class="help-block text-right text-danger">{{$message}}</span>
                                    @enderror
                                </div>
